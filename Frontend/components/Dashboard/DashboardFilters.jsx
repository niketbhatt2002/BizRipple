...
import { Building2, Calendar, Filter, MapPin, X } from "lucide-react";
import { Badge } from "../ui/badge";
import { Button } from "../ui/button";

export function DashboardFilters({ filters, setFilters }) {
  ...
  const hasActiveFilters = filters.province || filters.city || filters.year;

  useEffect(() => {
    fetch(`http://127.0.0.1:8000/api/filters/options?type=salon`)
      .then((res) => res.json())
      .then((data) => {
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {hasActiveFilters && (
            <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/30">
              {
                [filters.province, filters.city, filters.year].filter(Boolean)
                  .length
              }{" "}
              active
            </Badge>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="bg-slate-800/50 border-slate-700 hover:bg-slate-800 text-white focus:ring-green-500/50">
